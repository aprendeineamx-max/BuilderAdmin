...
// URL usando proxy Nginx HTTPS - evita Mixed Content Policy
// Las peticiones a https://inea.mx/auth/ serán proxy a http://localhost:8000/auth/
const supabaseUrl = process.env.NEXT_PUBLIC_SUPABASE_URL || 'https://inea.mx';
